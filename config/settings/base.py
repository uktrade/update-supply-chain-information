...
QUICKSIGHT_OVERSEAS_INTELLIGENCE_DASHBOARD_URL = env.str(
    "QUICKSIGHT_OVERSEAS_INTELLIGENCE_DASHBOARD_URL", default="about:blank"
)
QUICKSIGHT_RISK_MONITORING_DASHBOARD_URL = env.str(
    "QUICKSIGHT_RISK_MONITORING_DASHBOARD_URL", default="about:blank"
)
QUICKSIGHT_COMMODITY_USES_BY_INDUSTRY_DASHBOARD_URL = env.str(
    "QUICKSIGHT_COMMODITY_USES_BY_INDUSTRY_DASHBOARD_URL", default="about:blank"
)
QUICKSIGHT_VULNERABILITY_ANALYSIS_COUNTRIES_DASHBOARD_URL = env.str(
    "QUICKSIGHT_VULNERABILITY_ANALYSIS_COUNTRIES_DASHBOARD_URL", default="about:blank"
)
QUICKSIGHT_VULNERABILITY_ANALYSIS_PRODUCTS_DASHBOARD_URL = env.str(
    "QUICKSIGHT_VULNERABILITY_ANALYSIS_PRODUCTS_DASHBOARD_URL", default="about:blank"
)
