...
- run `make build`
- run `make first-use`
- run `make up` - this will bring the service up and stream logs to your console; OR
- run `make up-d` - this will bring the service up and detach from your console using the `-d` switch
